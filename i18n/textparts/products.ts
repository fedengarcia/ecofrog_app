  ...
  return [
    {
      ...
      modalData: {
        ...
        subtitle: tp(
          ...
          [{}, { highlight: true, bold: true }, {}, { bold: true }],
        ),
        icons: [
          {
            legend: (
        ...
        description_2: tp(
          ...
          [{}, { bold: true }, { break: true }, {}, { bold: true }],
        ),
        bubbleText: {
    ...
    },
    {
      ...
      modalData: {
        ...
        subtitle: tp(
          ...
          [{}, { bold: true }, {}, { bold: true, highlight: true }, {}],
        ),
        icons: [
          {
            legend: (
        ...
        description_1: tp(
          ...
          [{ bold: true, highlight: true }, {}, { bold: true }],
        ),
        description_2: tp(
